...
class MovieDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String date = DateFormat("yyyy-MM-dd").format(movie?.releaseDate ?? DateTime.now());
    return Scaffold(
                ...
                child: Stack(
                  children: <Widget>[
                    FadeInImage(
                      ...
                      image: NetworkImage(
                          "${Constants.baseImgUrl}${movie?.backdropPath ?? movie?.posterPath ?? "/qi6Edc1OPcyENecGtz8TF0DUr9e.jpg"}"),
                      fit: BoxFit.cover,
                      placeholder:
            ...
            child: Hero(
              ...
              child: SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: FadeInImage(
                    image: NetworkImage(
                        "${Constants.baseImgUrl}${movie?.posterPath}"),
                    fit: BoxFit.cover,
